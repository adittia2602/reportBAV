...
class Penyaluran extends CI_Controller
{
    ...
    public function download($idpenyalur)
    {
        ...
        foreach ($listdebtor as $item) {
            ...
            $object->getActiveSheet()->setCellValue('B' . $baris, $item['nik']);
            ...
            $object->getActiveSheet()->setCellValue('H' . $baris, $item['kodewilayah']);
            $object->getActiveSheet()->setCellValue('I' . $baris, $item['kodepos']);
            $object->getActiveSheet()->setCellValue('J' . $baris, $item['npwp']);
            ...
            $object->getActiveSheet()->setCellValue('Q' . $baris, $item['nomorhp']);
            ...
            $object->getActiveSheet()->setCellValue('V' . $baris, $item['noakad']);
