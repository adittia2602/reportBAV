                ...
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <div class="navbar-brand">
                        ...
                        <a href="<?=base_url('account'); ?>">
                            <b class="logo-icon">
                                <!-- Dark Logo icon -->
                                <img src="<?=base_url('assets/'); ?>images/bahana.jpg" alt="homepage" class="dark-logo" />
                                <!-- Light Logo icon -->
                                <img src="<?=base_url('assets/'); ?>images/bahana.jpg" alt="homepage" class="light-logo" />
                            </b>
                            <!--End Logo icon -->
                            <!-- Logo text -->
                    ...
                    <ul class="navbar-nav float-right">
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                                ...
                                <a class="dropdown-item" href="<?= base_url('account'); ?>"><i data-feather="user"
